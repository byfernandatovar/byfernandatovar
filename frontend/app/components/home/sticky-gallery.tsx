  ...
  ({ className = "", ...rest }, ref) => {
    return (
      <main
        ...
        {...rest}
      >
        <h2 className="text-center text-4xl font-semibold text-gray-800 mb-8">Un poco de mi trabajo</h2>
            ...
            <div className="grid gap-2 col-span-4">
              <figure className="w-full">
                <img
                  ...
                  alt=""
                  className="transition-all duration-300 w-full h-96 align-bottom object-cover"
                />
              </figure>
              <figure className="w-full">
                <img
