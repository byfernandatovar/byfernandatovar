...
export function HomeCta() {
  return (
    <section className="bg-[#F0EBE1] w-full h-screen bg-[url('/home-imgs/ctas/cta-2-bg.webp')] bg-cover bg-bottom flex items-center justify-center px-4 py-24 relative">
